#----------------------------------------------------------------------
# Github: DinoNuggyChan
# https://www.nuggy.space/
# https://github.com/DinoNuggyChan/PythonMusicPlayer
#----------------------------------------------------------------------
...
class MediaPanel(wx.Panel):
    ...
    def buildAudioBar(self):
        ...
        self.buildBtn({'bitmap':'player_prev.gif', 'handler':self.onPrev,
                       'name':'prev'},
                      audioBarSizer)
...
class MediaFrame(wx.Frame):
    ...
    #----------------------------------------------------------------------
    def __init__(self):
        wx.Frame.__init__(self, None, wx.ID_ANY, "DinoNuggyChan's Python Music Player")
